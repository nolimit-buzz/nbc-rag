...
export class MarketReportsController {
    ...
    async createMarketReport(
        ...
        const user = req.user;
        return this.marketReportsService.createMarketReport(createMarketReportDto, user);
    }

    @Get(':id')
    async getMarketReportById(@Param('id') id: string) {
        return this.marketReportsService.getMarketReportById(id);
    }
    ...
    async updateMarketReportSection(
        ...
        const user = req.user;
        console.log(user);
        return this.marketReportsService.updateMarketReportSection(id, sectionKey, updateSectionDto, user);
    }
    ...
    async updateMarketReportSubsection(
        ...
        return this.marketReportsService.updateMarketReportSubsection(id, sectionTitle, subsectionTitle, updateSubsectionDto);
    }
    ...
    async addSubsectionToSection(
        ...
        return this.marketReportsService.addSubsectionToSection(id, sectionTitle, subsectionData);
    }
    ...
    async removeSubsectionFromSection(
        ...
        return this.marketReportsService.removeSubsectionFromSection(id, sectionTitle, subsectionTitle);
    }
    ...
    async regenerateMarketReport(
        ...
        const user = req.user;
        return this.marketReportsService.regenerateMarketReport(id, body.sectionKey, body.marketPaper, user);
    }
    ...
    async regenerateMarketReportSubsection(
        ...
        const user = req.user;
        return this.marketReportsService.regenerateSubsection(id, body.sectionKey, body.subsectionKey, body.marketPaper, user);
    }
} 